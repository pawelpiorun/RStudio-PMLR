...
Modelowanie zostało przeprowadzone czterema różnymi metodami: cforest- Conditional Random Forest, ctree - Conditional Inference Trees, xgb - Extreme Gradient Boosting, rf - Random Forest 
...
W celu oceny dokładności wszystkich modeli zastosowano fukcję confusionMatrix.

```{r, code=readLines("Scripts\\prediction.R")}

```

Każdy z algorytmów został oceniony za pomocą takiej samej metryki. Wyniki walidacji:

LOSOWY PODZIAŁ DANYCH NA TESTOWE I TRENINGOWE

1. Conditional Random Forest

Confusion Matrix and Statistics

              Reference
Prediction     Not divorced Divorced
  Not divorced           24        1
  Divorced                1       24
